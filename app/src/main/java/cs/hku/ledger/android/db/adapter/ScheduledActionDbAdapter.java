...
public class ScheduledActionDbAdapter extends DatabaseAdapter<ScheduledAction> {
    ...
    /**
     * Builds a {@link ScheduledAction} instance from a row to cursor in the database.
    ...
    /**
     * Returns all {@link ScheduledAction}s from the database with the specified action UID.
